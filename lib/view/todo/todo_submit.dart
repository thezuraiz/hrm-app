...
class _TodoSubmitState extends State<TodoSubmit> {
  ...
  TodoController todoSubmitController = Get.put(TodoController());
              ...
              () => Column(
                ...
                children: [
                        ...
                        child: TextFormField(
                          ...
                          onTap: () {
                            globalController.selectDate(
                                context, todoSubmitController.startDate.value);
                          },
                          validator: RequiredValidator(errorText: "Required"),
                  ...
                  DropdownMenu(
                    ...
                    dropdownMenuEntries:
                        globalController.employeeData.map((value) {
                    ...
                    onSelected: (newValue) {
                      debugPrint("Dropdown Select: $newValue");
                      todoSubmitController.selectedEmplyee.value =
                          newValue.toString();
                    },
